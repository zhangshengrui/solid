...
<article class="page-container">
	<form action="fleet/editSupplier" method="post" class="form form-horizontal" id="form-member-add">
        <input type="hidden"  value="-1" name="id" id="f_id">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>车队编码：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="license" id="license">
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>车队负责人：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="official" name="official">
            </div>
        </div>
		<div class="row cl">
		...
		submitHandler:function(form){
			$(form).ajaxSubmit(function(data){
                if(data == "新增" || data == "修改" ){
                    ...
                    layer.msg('当前车队车牌号重复!',{icon:2,time:2000});
                }else{
