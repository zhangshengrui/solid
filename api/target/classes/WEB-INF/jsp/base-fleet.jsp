...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 基本信息管理 <span class="c-gray en">&gt;</span>车队信息管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:;" onclick="initTable()" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
    ...
    function initTable(){
        $('.table-sort').dataTable({
            "ajax":_basePath +"base/fleet/querySupplierList",
            "columns": [
                { "data": "",
    ...
    function operate(id,type){
        $.ajax({
            url:_basePath + "base/fleet/operate",
    ...
    function base_supplier_delete(id) {
        layer.prompt({
            ...
            $.ajax({
                url:_basePath + "base/fleet/delete",
