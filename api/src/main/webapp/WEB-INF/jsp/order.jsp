...
<div class="page-container">
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteSupplier()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="layer_show('添加供货商','base-supplier-add?id=-1','','540')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 录入订单</a></span> </div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-sort">
                <thead>
                <tr>
                    <th style="text-align: center" colspan="11">采购明细</th>
                    <th style="text-align: center"  colspan="8">销售明细</th>
                </tr>
                <tr class="text-c">
