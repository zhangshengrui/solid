...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 基本信息管理 <span class="c-gray en">&gt;</span>收货方信息管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:;" onclick="initTable()" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="page-container">
		<div class="text-c">
			<input type="text" id="s_name" placeholder="收货方名称" style="width:250px" class="input-text">&nbsp;&nbsp;
			<input type="text" id="s_tel"  placeholder="收货方负责人" style="width:250px" class="input-text">&nbsp;&nbsp;
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteSupplier()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="layer_show('添加收货方','base-receiver-add?id=-1','','630')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加收货方</a></span> </div>
		<div class="mt-20">
...
<script type="text/javascript">
    ...
    function initTable(){
        $('.table-sort').dataTable({
            "ajax":_basePath +"base/receiver/querySupplierList",
            "columns": [
                { "data": "",
                ...
                { "data": "status","render":function(data,type,full,collback){
                    if(data == '1'){
                        return '<td class="f-14 td-manage">' +
                            ...
                            '<a style="text-decoration:none" class="ml-5" onClick="layer_show(\'修改收货方信息\',\'base-receiver-add?id='+full.id+'\',\'\',\'630\')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> ' +
    ...
    function operate(id,type){
        $.ajax({
            url:_basePath + "base/receiver/operate",
    ...
    function base_supplier_delete(id) {
        layer.prompt({
            ...
            $.ajax({
                url:_basePath + "base/receiver/delete",
